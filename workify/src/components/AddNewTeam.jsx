...
const AddNewTeam = ({ setNewTeam }) => {
  ...
  const [selectedUsers, setSelectedUsers] = React.useState([{id:currentUser._id,role:"admin",access:"admin"}]);
  ...
  const CreateTeam = () => {
    ...
    createTeam({...inputs,member: selectedUsers ,projects:[]}, token)
      .then((res) => {
        console.log("I am in then of create team");
